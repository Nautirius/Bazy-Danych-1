...
CREATE TABLE IF NOT EXISTS lab08.funkcja (
...
CREATE TABLE IF NOT EXISTS lab08.wykladowca (
...
CREATE TABLE IF NOT EXISTS lab08.kurs (
...
CREATE TABLE IF NOT EXISTS lab08.zajecia(
...
--tabela koszty
create table IF NOT EXISTS lab08.koszty
    (wpis_id                        serial,
    kurs_id                         integer,
